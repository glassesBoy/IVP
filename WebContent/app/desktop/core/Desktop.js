 ...
 *          </p>
 */
Ext.define('ivp.desktop.core.Desktop', {
    extend : 'Ext.panel.Panel',
    alias : 'widget.desktop',
    itemId : 'desktopId',
    uses : ['Ext.util.MixedCollection', 'Ext.menu.Menu', 'Ext.view.View', // dataview
    'Ext.window.Window', 'ivp.desktop.core.TaskBar', 'ivp.desktop.core.Wallpaper'],
    ...
    /**
     * @cfg {Array|Store} shortcuts The items to add to the DataView. This can be a {@link Ext.data.Store Store} or a simple array. Items should minimally provide the fields in the
     *      {@link Ext.ux.desktop.ShorcutModel ShortcutModel}.
     */
    shortcuts : null,

    /**
     * @cfg {String} shortcutItemSelector This property is passed to the DataView for the desktop to select shortcut items. If the {@link #shortcutTpl} is modified, this will
     *      probably need to be modified as well.
     */
    shortcutItemSelector : 'div.ux-desktop-shortcut',

    /**
     * @cfg {String} shortcutTpl This XTemplate is used to render items in the DataView. If this is changed, the {@link shortcutItemSelect} will probably also need to changed.
     */
    shortcutTpl : ['<tpl for=".">', '  <div class="ux-desktop-shortcut" id="{name}-shortcut">', '<div class="ux-desktop-shortcut-icon {appIconCls}">', '<img src="',
            Ext.BLANK_IMAGE_URL, '" title="{name}">', '</div>', '<span class="ux-desktop-shortcut-text">{name}</span>', '</div>', '</tpl>', '<div class="x-clear"></div>  '],
    ...
    initComponent : function() {
        ...
        me.bbar = me.taskbar = new ivp.desktop.core.TaskBar(me.taskbarConfig);
        ...
        me.shortcutsView.on('resize', me.initShortcut, me);
    ...
    afterRender : function() {
        ...
        // 实现桌面图标自动换行
         Ext.Function.defer(me.initShortcut, 50);
        // me.initShortcut();
    },
    ...
    createDataView : function() {
        var me = this;
//        console.log('=============  me.shortcuts ', me.shortcuts);
        return {
            xtype : 'dataview',
...
//            },
    ...
    initShortcut : function() {
        ...
        var bottom;
        var numberOfItems = 0;
        var taskBarHeight = Ext.query(".ux-taskbar")[0].clientHeight + 20;
    ...
    onShortcutItemClick : function(dataView, record) {
        ...
        if (module) {
            ...
            module = Ext.create(record.data.classpath);
            module.app = me.app;
        }
         //console.log('========= module ',module);
    ...
    onRenderShortcut : function(v) {
        ...
        me.shortcutsView.dropZone = new Ext.dd.DropZone(v.getEl(), {
