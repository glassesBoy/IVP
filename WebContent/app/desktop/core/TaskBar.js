 ...
 */
Ext.define('ivp.desktop.core.TaskBar', {
    ...
    initComponent : function() {
        ...
        me.startMenu = new ivp.desktop.core.StartMenu(me.startConfig);
        me.quickStart = new Ext.toolbar.Toolbar(me.getQuickStart());

        var windowBarConfig = me.getWindowBarConfig();
      //  console.log('============= windowBarConfig ', windowBarConfig);

        me.windowBar = new Ext.toolbar.Toolbar(me.getWindowBarConfig());
        var trayConfig = me.getTrayConfig();
    ...
    /**
     * This method returns the configuration object for the Quick Start toolbar. A derived class can override this method, call the base version to build the config and then modify
     * the returned object before returning it.
     */
    ...
    /**
     * This method returns the configuration object for the Tray toolbar. A derived class can override this method, call the base version to build the config and then modify the
