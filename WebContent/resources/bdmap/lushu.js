...
(function() {
    ...
    c.prototype.start = function(callbackFun) {
    ...
    a.object.extend(c.prototype, {
        ...
        _move : function(n, j, m) {
            var i = this, h = 0, e = 10, f = this._opts.speed / (1000 / e), l = this._projection.lngLatToPoint(n), k = this._projection.lngLatToPoint(j), g = Math.round(i
                    ._getDistance(l, k)
                    / f);
            if (g < 1) {
                i._moveNext(++i.i);
