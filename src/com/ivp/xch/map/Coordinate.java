...
public class Coordinate {
    ...
    public static void GaussProjCal(double longitude, double latitude) {
        int ProjNo = 0;
        int ZoneWide; //// 带宽
     ...
     */
    // public void returnSquarePoint(double lng, double lat,double distance){
    //
    // distance = 0.5d;
    //
    // double dlng = 2 * asin(sin(distance / (2 * 6371)) / cos(deg2rad()));
    // dlng = rad2deg(dlng);
    //
    // double dlat = distance/6371;
    // double dlat = rad2deg($dlat);
    //
    // return array(
    ...
    //// 由经纬度反算成高斯投影坐标
    public static void BLToToGauss(double longitude, double latitude) {
        int ProjNo = 0;
        int ZoneWide; //// 带宽
        double longitude1, latitude1, longitude0, latitude0, X0, Y0, xval, yval;
        double a, f, e2, ee, NN, T, C, A, M, iPI;
    ...
    public static void main(String[] args) {
        Coordinate.BLToToGauss(109.25, 20.0);
    }
}
